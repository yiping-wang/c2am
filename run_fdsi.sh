...
python3 train_fdsi.py --config ./cfg/fdsi_exp37.yml
python3 make_cam_regular.py    --config ./cfg/fdsi_exp37.yml
python3 cam_to_ir_label.py     --config ./cfg/ir_net_exp37.yml
python3 train_irn.py           --config ./cfg/ir_net_exp37.yml
python3 make_sem_seg_labels.py --config ./cfg/ir_net_exp37.yml
python3 eval_sem_seg.py        --config ./cfg/ir_net_exp37.yml
echo "========================"
