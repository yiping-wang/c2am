...
python3 cam_to_ir_label.py        --config    ./cfg/baseline/ir_net_baseline_512.yml
python3 train_irn.py              --config    ./cfg/baseline/ir_net_baseline_512.yml
python3 make_sem_seg_labels.py    --config    ./cfg/baseline/ir_net_baseline_512.yml
python3 eval_sem_seg.py           --config    ./cfg/baseline/ir_net_baseline_512.yml
echo "======================================="