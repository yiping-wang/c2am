...
python3 eval_cam.py               --config    ./cfg/c2am_exp_03.yml --cam_eval_thres 0.10
python3 eval_cam.py               --config    ./cfg/c2am_exp_03.yml --cam_eval_thres 0.12
python3 eval_cam.py               --config    ./cfg/c2am_exp_03.yml --cam_eval_thres 0.14
python3 eval_cam.py               --config    ./cfg/c2am_exp_03.yml --cam_eval_thres 0.16
python3 eval_cam.py               --config    ./cfg/c2am_exp_03.yml --cam_eval_thres 0.18
python3 eval_cam.py               --config    ./cfg/c2am_exp_03.yml --cam_eval_thres 0.20
...
rm /data/home/yipingwang/data/IRLabelC2AM/*
rm /data/home/yipingwang/data/SemSegC2AM/*
python3 train_c2am.py             --config    ./cfg/c2am_exp_06.yml
python3 make_cam.py               --config    ./cfg/c2am_exp_06.yml
python3 eval_cam.py               --config    ./cfg/c2am_exp_06.yml --cam_eval_thres 0.10
python3 eval_cam.py               --config    ./cfg/c2am_exp_06.yml --cam_eval_thres 0.12
python3 eval_cam.py               --config    ./cfg/c2am_exp_06.yml --cam_eval_thres 0.14
python3 eval_cam.py               --config    ./cfg/c2am_exp_06.yml --cam_eval_thres 0.16
python3 eval_cam.py               --config    ./cfg/c2am_exp_06.yml --cam_eval_thres 0.18
python3 eval_cam.py               --config    ./cfg/c2am_exp_06.yml --cam_eval_thres 0.20
...
python3 eval_cam.py               --config    ./cfg/c2am_exp_02.yml --cam_eval_thres 0.12
python3 eval_cam.py               --config    ./cfg/c2am_exp_02.yml --cam_eval_thres 0.14
python3 eval_cam.py               --config    ./cfg/c2am_exp_02.yml --cam_eval_thres 0.16
python3 eval_cam.py               --config    ./cfg/c2am_exp_02.yml --cam_eval_thres 0.18
