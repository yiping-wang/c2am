...
python3 eval_cam.py               --config    ./cfg/c2am_exp_01.yml --cam_eval_thres 0.17
python3 eval_cam.py               --config    ./cfg/c2am_exp_01.yml --cam_eval_thres 0.18
python3 eval_cam.py               --config    ./cfg/c2am_exp_01.yml --cam_eval_thres 0.19
python3 eval_cam.py               --config    ./cfg/c2am_exp_01.yml --cam_eval_thres 0.20
python3 eval_cam.py               --config    ./cfg/c2am_exp_01.yml --cam_eval_thres 0.21
python3 eval_cam.py               --config    ./cfg/c2am_exp_01.yml --cam_eval_thres 0.22
python3 eval_cam.py               --config    ./cfg/c2am_exp_01.yml --cam_eval_thres 0.23
...
python3 eval_cam.py               --config    ./cfg/c2am_exp_03.yml --cam_eval_thres 0.22
...
# python3 cam_to_ir_label.py        --config    ./cfg/irn_c2am_exp_04.yml
# python3 train_irn.py              --config    ./cfg/irn_c2am_exp_04.yml
# python3 make_sem_seg_labels.py    --config    ./cfg/irn_c2am_exp_04.yml
# python3 eval_sem_seg.py           --config    ./cfg/irn_c2am_exp_04.yml
echo "======================================="