...
# python3 eval_cam.py               --config    ./cfg/c2am_exp_02.yml --cam_eval_thres 0.19
# python3 eval_cam.py               --config    ./cfg/c2am_exp_02.yml --cam_eval_thres 0.20
# python3 eval_cam.py               --config    ./cfg/c2am_exp_02.yml --cam_eval_thres 0.21
# python3 eval_cam.py               --config    ./cfg/c2am_exp_02.yml --cam_eval_thres 0.22
# python3 eval_cam.py               --config    ./cfg/c2am_exp_02.yml --cam_eval_thres 0.23
