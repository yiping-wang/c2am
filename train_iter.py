...
if __name__ == '__main__':
    os.system('cp /data/home/yipingwang/data/Models/Classification/resnet50_baseline.pth /data/home/yipingwang/data/Models/Classification/resnet50_iter_32.pth')
